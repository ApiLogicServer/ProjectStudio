...
3. If you have logic requirements, we can translate them together in `logic/declare_logic.py`, using the created project's own `docs/training/logic_bank_api.md` reference.
...
4. **I'll use Method 4** (business prompt -> full system) for AI-generated projects with logic
